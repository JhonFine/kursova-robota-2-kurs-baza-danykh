...
namespace CarRental.WebApi.Data.Migrations
{
    ...
    [Migration("20260314204758_AddClientProfilesAndRentalLocations")]
    partial class AddClientProfilesAndRentalLocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRental.WebApi.Models.AdminWriteAccessGrant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("TargetEmployeeId", "ExpiresAtUtc", "RevokedAtUtc");

                    b.ToTable("AdminWriteAccessGrants");
                });
            ...
            modelBuilder.Entity("CarRental.WebApi.Models.AdminWriteAccessGrant", b =>
                {
                    b.HasOne("CarRental.WebApi.Models.Employee", "ApprovedByEmployee")
                        .WithMany()
                        .HasForeignKey("ApprovedByEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CarRental.WebApi.Models.Employee", "RevokedByEmployee")
                        .WithMany()
                        .HasForeignKey("RevokedByEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CarRental.WebApi.Models.Employee", "TargetEmployee")
                        .WithMany()
