...
namespace CarRental.WebApi.Data.Migrations
{
    ...
    [Migration("20260327203538_HardenVehicleAvailabilityAndRentalIntegrity")]
    partial class HardenVehicleAvailabilityAndRentalIntegrity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarRental.WebApi.Models.Rental", b =>
                {
                    ...
                    b.ToTable("Rentals", t =>
                        {
                            t.HasCheckConstraint("CK_Rentals_Canceled_Lifecycle", "\"Status\" <> 4 OR (\"IsClosed\" = FALSE AND \"ClosedAtUtc\" IS NULL AND \"CanceledAtUtc\" IS NOT NULL AND length(btrim(COALESCE(\"CancellationReason\", ''))) > 0)");

                            t.HasCheckConstraint("CK_Rentals_Closed_Lifecycle", "\"Status\" <> 3 OR (\"IsClosed\" = TRUE AND \"ClosedAtUtc\" IS NOT NULL AND \"CanceledAtUtc\" IS NULL AND \"CancellationReason\" IS NULL)");
